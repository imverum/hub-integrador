...
from apps.projeto.views import projeto_status, projeto_master_index, projeto_home, projeto_deletar, register_projeto, projeto_ged, projeto_edit_ajax, projeto_edit
